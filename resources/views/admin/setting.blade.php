            ...
            <div class="col-12">
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body">
                            ...
                            <div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">
                                <form>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control form-control-lg" id="site_description" name="site_description" rows="2" placeholder="Deskripsi singkat website"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="mt-2">
                                                    <img src="/admin/images/logos/favicon-v2.png" alt="Favicon" class="img-thumbnail rounded-3" style="max-height: 50px;">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <button type="button" class="btn btn-outline-primary btn-sm" data-bs-toggle="modal" data-bs-target="#hobbyCategoriesModal">
                                            <i class="ti ti-edit me-2"></i>Kelola Kategori Hobi
                                        </button>
                                        <div class="mt-2">
                                            <small class="text-muted">Klik untuk mengelola kategori hobi</small>
                                        </div>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                                <form>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control form-control-lg" id="address" name="address" rows="3" placeholder="Masukkan alamat lengkap"></textarea>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control form-control-lg" id="whatsapp" name="whatsapp" placeholder="Nomor WhatsApp">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control form-control-lg" id="telegram" name="telegram" placeholder="Username Telegram">
                                            </div>
                                        </div>
                                    </div>
                                </form>
                            ...
                            <div class="tab-pane fade" id="social" role="tabpanel" aria-labelledby="social-tab">
                                <form>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="url" class="form-control form-control-lg" id="facebook" name="facebook" placeholder="https://facebook.com/username">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="url" class="form-control form-control-lg" id="instagram" name="instagram" placeholder="https://instagram.com/username">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="url" class="form-control form-control-lg" id="twitter" name="twitter" placeholder="https://twitter.com/username">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="url" class="form-control form-control-lg" id="linkedin" name="linkedin" placeholder="https://linkedin.com/in/username">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="url" class="form-control form-control-lg" id="youtube" name="youtube" placeholder="https://youtube.com/channel/UC...">
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="modal fade" id="hobbyCategoriesModal" tabindex="-1" aria-labelledby="hobbyCategoriesModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="new_category" placeholder="Masukkan nama kategori">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div id="categoriesList" class="list-group">
                                                ...
                                                <div class="list-group-item d-flex justify-content-between align-items-center">
                                                    Olahraga
                                                    <button class="btn btn-sm btn-outline-danger" onclick="removeCategory(this)">
