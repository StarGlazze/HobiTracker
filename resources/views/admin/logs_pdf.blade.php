...
<body>
    ...
    <div class="info-box">
        ...
        @if ($startDate && $endDate)
            <p><strong>Period:</strong> {{ \Carbon\Carbon::parse($startDate)->format('d F Y') }} -
        ...
        <div style="margin-bottom: 20px; page-break-inside: avoid;">
            <table style="margin-bottom: 10px;">
                ...
                <tr>
                    ...
                    <td>{{ $log->aktivitas && $log->aktivitas->target && $log->aktivitas->target->hobi ? $log->aktivitas->target->hobi->nama_hobi : '-' }}
                    </td>
                </tr>
                <tr>
