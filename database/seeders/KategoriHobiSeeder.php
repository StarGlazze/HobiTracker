...
class KategoriHobiSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $kategoriHobis = [
            ...
            ['nama_kategori' => 'Gaming & E-Sports', 'icon' => 'ti-device-gamepad', 'background_color' => 'bg-purple'],
            ...
            ['nama_kategori' => 'Koleksi & Hobi Khusus', 'icon' => 'ti-archive', 'background_color' => 'bg-dark'], 
